...
<table>
 ...
 <tbody>
    ...
    <tr>
      <td>Novo recurso</td>
      <td>✨ <code>:sparkles: feature:</code></td>
    </tr>
    <tr>
      <td>Performance</td>
      <td>⚡ <code>:zap: performance:</code></td>
    </tr>
    <tr>
        <td>Refatoração</td>
...
- `dependences` - Commits do tipo build são utilizados quando são realizadas modificações em **arquivos de build e dependências**.

- `performance` - Commits do tipo perf servem para identificar quaisquer alterações de código que estejam relacionadas a **performance**.
